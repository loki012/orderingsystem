...
public class Tables {
    ...
    public static void main(String[] args) {
        try {
            ...
            //String adminTable = "INSERT INTO user (name,mobilenumber,address,email,password,status) VALUES ('Admin Jay','09167314145','Laoag Ilocos Norte','adminjay@gmail.com','admin12345','true')";
            //DBOperations.setDataOrDelete(adminTable, "Admin Details Added Succesfully");
